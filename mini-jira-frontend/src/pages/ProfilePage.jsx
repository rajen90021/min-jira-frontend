    ...
    return (
        <div className="p-8 space-y-8 bg-transparent min-h-full overflow-auto">
            ...
            >
                ...
                <p className="text-slate-500  font-bold uppercase text-[10px] tracking-[0.2em]">System Signal & Interface Credentials</p>
            </motion.div>
            ...
            <div className="max-w-6xl">
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="bg-white  rounded-[2.5rem] p-8 border border-slate-200  shadow-sm text-center relative overflow-hidden">
                            ...
                            <div className="relative inline-block mb-8 mt-4">
                                ...
                                <div className={`absolute -bottom-2 -right-2 w-8 h-8 rounded-2xl border-4 border-white  shadow-lg ${user?.role?.toLowerCase() === 'manager' ? 'bg-amber-500' : 'bg-blue-600'
                                    }`} />
                            </div>
                            ...
                            <div className="mt-10 space-y-4">
                                <div className="flex items-center gap-4 p-4 rounded-3xl bg-slate-50  border border-slate-100  group hover:bg-slate-100 :bg-slate-800 transition-all">
                                    <div className="w-10 h-10 rounded-2xl bg-white  border border-slate-200  flex items-center justify-center text-slate-400 group-hover:text-blue-600 transition-colors shadow-sm">
                                        <IoMail size={20} />
                                    </div>
                    ...
                    >
                        <div className="bg-white  rounded-[2.5rem] p-10 border border-slate-200  shadow-sm min-h-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    ...
                                    <div className="w-full px-6 py-4 rounded-2xl bg-slate-50  border border-slate-200  text-slate-800  font-bold shadow-sm">
                                        {user?.name || 'N/A'}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="w-full px-6 py-4 rounded-2xl bg-slate-50  border border-slate-200  text-slate-800  font-bold shadow-sm flex items-center gap-3">
                            ...
                            <div className="mt-12 p-8 bg-blue-50  border border-blue-100  rounded-3xl">
                                <h4 className="text-blue-600  font-black text-[10px] uppercase tracking-[0.2em] mb-3">Architect Protocol</h4>
